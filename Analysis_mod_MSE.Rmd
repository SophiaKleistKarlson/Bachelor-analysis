...
mcmc_rank_overlay(MSE_mod1, 
                  pars = c("b_moGeneration", "b_moGeneration:Condition2", "b_moGeneration:Condition3", "b_moGeneration:Condition4")) + 
  theme_classic()
...
hypothesis(MSE_mod1,"Condition1 > Condition2") 
hypothesis(MSE_mod1,"Condition1 > Condition3")
hypothesis(MSE_mod1,"Condition1 > Condition4")

hypothesis(MSE_mod1,"Condition2 = Condition3")
hypothesis(MSE_mod1,"Condition3 = Condition4")
hypothesis(MSE_mod1,"Condition2 = Condition4")


hypothesis(MSE_mod1,"moGeneration1 = 0") # this is the most probable in terms of generation

hypothesis(MSE_mod1,"Condition2:moGeneration1 > 0") # this is more probable than =, and a LOT more than <
hypothesis(MSE_mod1,"Condition3:moGeneration1 > 0") # this is more probable than =, and a LOT more than <
hypothesis(MSE_mod1,"Condition4:moGeneration1 > 0") # this is more probable than =, and a LOT more than <


plot(hypothesis(MSE_mod1,"Condition1 > Condition2"))
plot(hypothesis(MSE_mod1,"Condition1 > Condition3"))
plot(hypothesis(MSE_mod1,"Condition1 > Condition4"))

plot(hypothesis(MSE_mod1,"Condition2 = Condition3"))
plot(hypothesis(MSE_mod1,"Condition3 = Condition4"))
plot(hypothesis(MSE_mod1,"Condition2 = Condition4"))
