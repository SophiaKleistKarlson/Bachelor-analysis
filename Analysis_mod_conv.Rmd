...
prior_convention_mod <- c(
  ...
  #prior(normal(0, 0.15),        class = sd), #mean: 0 (I expect that they might not vary at all). sd for the mean conv for each dubject = 0.30. sigma should go from 0 (the mean of the prior) to around that -> sigma: 0.15.
