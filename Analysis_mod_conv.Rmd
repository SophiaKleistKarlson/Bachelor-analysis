...
# Define the model
convention_mod <- bf(Conventionality ~ 1 + Generation + Condition + Generation:Condition + 
                       (1 + Generation + Condition + Generation:Condition | Subject:Chain)+
                       (1 + Generation + Condition + Generation:Condition | Source_image))
