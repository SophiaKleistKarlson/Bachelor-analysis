...
# these two could have replaced the two top ones, but they gave sligthly smaller estimated error, so I chose the other option as seen above
#hypothesis(complexity_mod1,"(0.74*7 + moGeneration*21)/7 > 0", class="bsp")
#hypothesis(complexity_mod1,"(0.34*7 + moGeneration:Condition2*21)/7 < 0", class="bsp")
