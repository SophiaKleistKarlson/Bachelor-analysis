...
hypothesis(complexity_mod1,"Condition1 > 0")
hypothesis(complexity_mod1,"(Condition2 - Condition1) < 0")
hypothesis(complexity_mod1,"(Condition1 + Condition3) < 0")
hypothesis(complexity_mod1,"(Condition1 + Condition4) < 0")

hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition2)") 
hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition3)")
hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition4)")

hypothesis(complexity_mod1,"(Condition1 + Condition2) = (Condition1 + Condition3)")
hypothesis(complexity_mod1,"(Condition1 + Condition3) = (Condition1 + Condition4)")
hypothesis(complexity_mod1,"(Condition1 + Condition2) = (Condition1 + Condition4)")

# overall effect of generation
hypothesis(complexity_mod1,"(moGeneration + (moGeneration + moGeneration:Condition2) + (moGeneration + moGeneration:Condition3) + (moGeneration + moGeneration:Condition4))/4 < 0", class = "bsp")

# effects of the interactions between generation and conditions
hypothesis(complexity_mod1,"moGeneration = 0", class = "bsp")
hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition2) < 0", class = "bsp") 
hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition3) < 0", class = "bsp") 
hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition4) < 0", class = "bsp")


# plot the best hypotheses
plot(hypothesis(complexity_mod1,"Condition1 = 0"))
plot(hypothesis(complexity_mod1,"(Condition1 + Condition2) < 0"))
plot(hypothesis(complexity_mod1,"(Condition1 + Condition3) < 0"))
plot(hypothesis(complexity_mod1,"(Condition1 + Condition4) < 0"))

plot(hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition2)")) 
plot(hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition3)"))
plot(hypothesis(complexity_mod1,"Condition1 > (Condition1 + Condition4)"))

plot(hypothesis(complexity_mod1,"(Condition1 + Condition2) = (Condition1 + Condition3)"))
plot(hypothesis(complexity_mod1,"(Condition1 + Condition3) = (Condition1 + Condition4)"))
plot(hypothesis(complexity_mod1,"(Condition1 + Condition2) = (Condition1 + Condition4)"))

plot(hypothesis(complexity_mod1,"((moGeneration + (moGeneration + moGeneration:Condition2) + (moGeneration + moGeneration:Condition3) + (moGeneration + moGeneration:Condition4))/4 = 0", class = "bsp"))
plot(hypothesis(complexity_mod1,"moGeneration < 0", class = "bsp"))
plot(hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition2) < 0", class = "bsp"))
plot(hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition3) < 0", class = "bsp")) 
plot(hypothesis(complexity_mod1,"(moGeneration + moGeneration:Condition4) < 0", class = "bsp"))
