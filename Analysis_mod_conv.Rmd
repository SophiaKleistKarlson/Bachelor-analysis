...
Conventionality ~ 0 + Condition*Generation +
  (0 + Condition*Generation | Source_image) +
  (0 + Condition*Generation | gr(Subject, by = c(Chain, Generation)))
...
class(df_conventionality$Subject)
df_conventionality$Subject <- as.factor(df_conventionality$Subject)
...
# scaling conventionality to make it easier to deal with and interpret
...
sd(df_subj$conv_mean)#get the standard deviation of the mean complexity for each participant (0.2970962). Divide this in two (0.1485481) # scaled = 0.11, half = 0.06
