...
sd(df_part$compl_mean) #get the standard deviation of the mean complexity for each participant = 3159.295. Divide this in two = 1579.648. Scaled: 
...
sd(df_source$mean_comp)/2 # scaled = , half = 
...
mcmc_rank_overlay(complexity_mod1, 
                  pars = c("b_Condition2", "b_Condition3", "b_Condition4")) + 
  theme_classic()
...
# these don't work...
hypothesis(complexity_mod1,"moGeneration1 < 0")
