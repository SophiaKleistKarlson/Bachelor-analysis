...
hypothesis(convention_mod1,"Condition1 = 0")
hypothesis(convention_mod1,"(Condition1 + Condition2) = 0")
hypothesis(convention_mod1,"(Condition1 + Condition3) = 0")
hypothesis(convention_mod1,"(Condition1 + Condition4) = 0")


hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition2)") 
hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition3)")
hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition4)")

hypothesis(convention_mod1,"(Condition1 + Condition2) = (Condition1 + Condition3)")
hypothesis(convention_mod1,"(Condition1 + Condition3) = (Condition1 + Condition4)")
hypothesis(convention_mod1,"(Condition1 + Condition2) = (Condition1 + Condition4)")

# overall effect of generation
hypothesis(convention_mod1,"((moGeneration + (moGeneration + moGeneration:Condition2) + (moGeneration + moGeneration:Condition3) + (moGeneration + moGeneration:Condition4))/4 = 0", class = "bsp")

# effects of the interactions between generation and conditions
hypothesis(convention_mod1,"moGeneration < 0", class = "bsp") #this is the interaction between condition 1 and generation
hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition2) < 0", class = "bsp") 
hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition3) < 0", class = "bsp") 
hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition4) < 0", class = "bsp")


# plot the best hypotheses
plot(hypothesis(convention_mod1,"Condition1 = 0"))
plot(hypothesis(convention_mod1,"(Condition1 + Condition2) = 0"))
plot(hypothesis(convention_mod1,"(Condition1 + Condition3) = 0"))
plot(hypothesis(convention_mod1,"(Condition1 + Condition4) = 0"))


plot(hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition2)")) 
plot(hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition3)"))
plot(hypothesis(convention_mod1,"Condition1 > (Condition1 + Condition4)"))

plot(hypothesis(convention_mod1,"(Condition1 + Condition2) = (Condition1 + Condition3)"))
plot(hypothesis(convention_mod1,"(Condition1 + Condition3) = (Condition1 + Condition4)"))
plot(hypothesis(convention_mod1,"(Condition1 + Condition2) = (Condition1 + Condition4)"))

plot(hypothesis(convention_mod1,"((moGeneration + (moGeneration + moGeneration:Condition2) + (moGeneration + moGeneration:Condition3) + (moGeneration + moGeneration:Condition4))/4 = 0", class = "bsp"))
plot(hypothesis(convention_mod1,"moGeneration < 0", class = "bsp"))
plot(hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition2) < 0", class = "bsp"))
plot(hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition3) < 0", class = "bsp")) 
plot(hypothesis(convention_mod1,"(moGeneration + moGeneration:Condition4) < 0", class = "bsp"))
