...
hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 < 0")
hypothesis(convention_mod1,"(Condition3*8 - 0.22*28)/8 = 0")
hypothesis(convention_mod1,"(Condition4*8 - 0.21*28)/8 = 0")
...
hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition2*8 - 0.25*28)/8") 
hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition3*8 - 0.22*28)/8")
hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition4*8 - 0.21*28)/8")
hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 = (Condition3*8 - 0.22*28)/8")
hypothesis(convention_mod1,"(Condition3*8 - 0.22*28)/8 = (Condition4*8 - 0.21*28)/8")
hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 = (Condition4*8 - 0.21*28)/8")
...
plot(hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 < 0"))
plot(hypothesis(convention_mod1,"(Condition3*8 - 0.22*28)/8 = 0"))
plot(hypothesis(convention_mod1,"(Condition4*8 - 0.21*28)/8 = 0"))
# these two could have replaced the two top ones, but they gave sligtly smaller estimated error, so I chose the other option as seen above
#hypothesis(convention_mod1,"(0.74*7 + moGeneration*21)/7 > 0", class="bsp")
#hypothesis(convention_mod1,"(0.34*7 + moGeneration:Condition2*21)/7 < 0", class="bsp")

# relations between the conditions
plot(hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition2*8 - 0.25*28)/8"))
plot(hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition3*8 - 0.22*28)/8"))
plot(hypothesis(convention_mod1,"(Condition1*8 + 0.01*28)/8 > (Condition4*8 - 0.21*28)/8"))

plot(hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 = (Condition3*8 - 0.22*28)/8"))
plot(hypothesis(convention_mod1,"(Condition3*8 - 0.22*28)/8 = (Condition4*8 - 0.21*28)/8"))
plot(hypothesis(convention_mod1,"(Condition2*8 - 0.25*28)/8 = (Condition4*8 - 0.21*28)/8"))
