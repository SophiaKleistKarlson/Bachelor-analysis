...
data <- read_csv("data/csv_files/all_data_w_source.csv") # we use all_data_w_all_conv_source.csv
...
prior_complexity_mod <- c(
  prior(normal(0, 1),     class = b), #mean and sd of complexity #24641.25, 6401.52
  prior(lkj(1),                        class = cor),
  #prior(normal(24641.25, 6399.96),     class = Intercept), #mean and sd of complexity
  prior(normal(1, 0.5),      class = sigma), #mean: sd of complexity sigma: half of the sd of complexity #6401.52, 3200.76
  
  # simo priors for the monotonic generation variable
  ...
  prior(normal(0, 0.25),            class = sd) #mean: 0 (I expect that they might not vary at all). sd for the mean complexity for each participant = 2780.45. sigma should go from 0 (the mean of the prior) to around that -> sigma: 1579.648.
)
